...
Window {
    ...
    Connections {
        ...
        function onAppStateChanged(state) {
            var wasHud = (root._prevState === "idle" || root._prevState === "gaming")
            var isHud  = (state === "idle" || state === "gaming")
    ...
    Rectangle {
        ...
        readonly property color stateColor: {
            ...
            if (hud.appState === "off")           return Qt.rgba(0.0, 1.0, 0.53, 1)
        ...
        Item {
            ...
            Text { id:bootStatusTxt; anchors.centerIn:parent
                   text: hud.appState==="off"        ? "POWER OK  ■  BC250 OFFLINE"  :
